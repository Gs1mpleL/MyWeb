...
public class BiliCoinApply implements Task {
    ...
    public void run() {
        try{
            ...
            /* B币券余额 */
            int couponBalance = Integer.parseInt(biliData.getCouponBalance());
